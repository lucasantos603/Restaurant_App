    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <nav :class="{ 'block': open, 'hidden': !open }"
                ...
                <x-admin-nav-link :href="route('admin.menus.index')" :active="request()->routeIs('admin.menus.indexk')">
                    {{ __('Menus') }}
                </x-admin-nav-link>
                ...
                {{-- Fim DropDown button Nav --}}
            </nav>
            {{-- Fim dos Botos de navegação --}}
        </div>
